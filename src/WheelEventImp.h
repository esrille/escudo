...
public:
    ...
    // WheelEvent-43
    void initWheelEvent(const std::u16string& typeArg, bool canBubbleArg, bool cancelableArg, html::Window viewArg, int detailArg, int screenXArg, int screenYArg, int clientXArg, int clientYArg, unsigned short buttonArg, events::EventTarget relatedTargetArg, const std::u16string& modifiersListArg, double deltaXArg, double deltaYArg, double deltaZArg, unsigned int deltaMode);
    // Object
