...
#ifndef ORG_W3C_DOM_BOOTSTRAP_NAVIGATORCONTENTUTILSIMP_H_INCLUDED
#define ORG_W3C_DOM_BOOTSTRAP_NAVIGATORCONTENTUTILSIMP_H_INCLUDED

#ifdef HAVE_CONFIG_H
#include "config.h"
#endif

#include <org/w3c/dom/html/NavigatorContentUtils.h>
...
namespace bootstrap
{
class NavigatorContentUtilsImp : public ObjectMixin<NavigatorContentUtilsImp>
{
public:
    ...
    {
        return html::NavigatorContentUtils::dispatch(this, selector, id, argc, argv);
    }
    static const char* const getMetaData()
    {
        return html::NavigatorContentUtils::getMetaData();
    }
};
...
#endif  // ORG_W3C_DOM_BOOTSTRAP_NAVIGATORCONTENTUTILSIMP_H_INCLUDED
