...
#include <org/w3c/dom/DataView.h>
...
namespace bootstrap
{
class DataViewImp : public ObjectMixin<DataViewImp>
{
public:
    // DataView
    ...
    {
        return DataView::dispatch(this, selector, id, argc, argv);
    }
    static const char* const getMetaData()
    {
        return DataView::getMetaData();
    }
};
