...
namespace bootstrap
{
class Float64ArrayImp : public ObjectMixin<Float64ArrayImp>
{
public:
    // Float64Array
    ...
    void set(Float64Array array, unsigned int offset);
    ...
    {
        return Float64Array::dispatch(this, selector, id, argc, argv);
    }
    static const char* const getMetaData()
    {
        return Float64Array::getMetaData();
    }
};
