...
public:
    ...
    // CompositionEvent-45
    void initCompositionEvent(const std::u16string& typeArg, bool canBubbleArg, bool cancelableArg, html::Window viewArg, const Nullable<std::u16string>& dataArg, const std::u16string& localeArg);
    // Object
