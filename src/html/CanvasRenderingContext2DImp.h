...
public:
    ...
    html::CanvasPattern createPattern(Any image, const std::u16string& repetition);
    ...
    void beginPath();
    void fill();
    void fill(html::Path path);
    void stroke();
    void stroke(html::Path path);
    void drawSystemFocusRing(Element element);
    void drawSystemFocusRing(html::Path path, Element element);
    bool drawCustomFocusRing(Element element);
    bool drawCustomFocusRing(html::Path path, Element element);
    void scrollPathIntoView();
    void scrollPathIntoView(html::Path path);
    void clip();
    void clip(html::Path path);
    bool isPointInPath(double x, double y);
    bool isPointInPath(html::Path path, double x, double y);
    ...
    void drawImage(Any image, double dx, double dy);
    void drawImage(Any image, double dx, double dy, double dw, double dh);
    void drawImage(Any image, double sx, double sy, double sw, double sh, double dx, double dy, double dw, double dh);
    void addHitRegion(html::HitRegionOptions options);
    void removeHitRegion(html::HitRegionOptions options);
