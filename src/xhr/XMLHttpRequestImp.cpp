...
void XMLHttpRequestImp::send(const Nullable<std::u16string>& data)
{
    // TODO: implement me!
}
...
std::u16string XMLHttpRequestImp::getResponseHeader(const std::u16string& header)
{
    // TODO: implement me!
    return u"";
}
...
void XMLHttpRequestImp::setResponseType(const std::u16string& responseType)
{
    // TODO: implement me!
}
