...
public:
    ...
    html::Selection getSelection() __attribute__((weak));
    ...
    html::Function getOnformchange() __attribute__((weak));
    void setOnformchange(html::Function onformchange) __attribute__((weak));
    html::Function getOnforminput() __attribute__((weak));
    void setOnforminput(html::Function onforminput) __attribute__((weak));
    ...
    // HTMLDocument-36
    NodeList getItems() __attribute__((weak));
    NodeList getItems(std::u16string typeNames) __attribute__((weak));
    // Object
