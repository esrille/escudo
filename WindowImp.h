...
public:
    ...
    std::u16string prompt(std::u16string message);
    std::u16string prompt(std::u16string message, std::u16string _default);
    void print();
    ...
    html::Function getOnformchange();
    void setOnformchange(html::Function onformchange);
    html::Function getOnforminput();
    void setOnforminput(html::Function onforminput);
